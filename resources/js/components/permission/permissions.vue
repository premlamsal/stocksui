<template>
  <div>
    ...
    <b-modal id="bv-modal-add-permission" hide-footer>
      ...
      <div class="row m-4">
        <div class="col-md-2">
          <span style="font-weight: bold; margin-bottom: 20px">View</span>
          <div class="form-group">
            ...
            />
            <label class="form-check-label" for="view_contacts">
              Contact
            </label>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            <input
              class="form-check-input"
              type="checkbox"
              value="view_pick_lists"
              v-model="checkedPermissions"
            />
            <label class="form-check-label" for="view_pick_lists">
              Pick List
            </label>
          </div>
          <div class="form-group">
        ...
        <div class="col-md-2">
          ...
          <div class="form-group">
            <input
              ...
              v-model="checkedPermissions"
            />
            <label class="form-check-label" for="add_contact"> Contact </label>
          </div>
          <div class="form-group">
            <input
              class="form-check-input"
          ...
          <div class="form-group">
            <input
              ...
              v-model="checkedPermissions"
            />
            <label class="form-check-label" for="add_product"> Product </label>
          </div>
          <div class="form-group">
            <input
              class="form-check-input"
          ...
          <div class="form-group">
            <input
              ...
              v-model="checkedPermissions"
            />
            <label class="form-check-label" for="add_pick_list">
              Pick List
            </label>
          </div>
          <div class="form-group">
            <input
              class="form-check-input"
              type="checkbox"
              value="add_stock_list"
              v-model="checkedPermissions"
            />
            <label class="form-check-label" for="add_stock_list">
              Stock List
            </label>
          </div>
          <div class="form-group">
            <input
              class="form-check-input"
              type="checkbox"
              value="add_users_list"
              v-model="checkedPermissions"
            />
            <label class="form-check-label" for="add_user"> Users </label>
          </div>
          <div class="form-group">
            <input
              class="form-check-input"
              type="checkbox"
              value="add_settings_list"
              v-model="checkedPermissions"
            />
            <label class="form-check-label" for="add_settings">
              Settings
            </label>
          </div>
          <div class="form-group">
        ...
        <div class="col-md-2">
          ...
          <div class="form-group">
            <input
              ...
              v-model="checkedPermissions"
            />
            <label class="form-check-label" for="edit_contact"> Contact </label>
          </div>
          <div class="form-group">
            <input
              class="form-check-input"
          ...
          <div class="form-group">
            <input
              ...
              v-model="checkedPermissions"
            />
            <label class="form-check-label" for="edit_product"> Product </label>
          </div>
          <div class="form-group">
            <input
              class="form-check-input"
          ...
          <div class="form-group">
            <input
              class="form-check-input"
              type="checkbox"
              value="edit_pick_list"
              v-model="checkedPermissions"
            />
            <label class="form-check-label" for="edit_pick_list">
              Pick List
            </label>
          </div>
          <div class="form-group">
        ...
        <div class="col-md-2">
          ...
          <div class="form-group">
            <input
              ...
              v-model="checkedPermissions"
            />
            <label class="form-check-label" for="delete_contact">
              Contact
            </label>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            <input
              class="form-check-input"
              type="checkbox"
              value="delete_pick_list"
              v-model="checkedPermissions"
            />
            <label class="form-check-label" for="delete_pick_list">
              Pick List
            </label>
          </div>
          <div class="form-group">
            <input
              class="form-check-input"
              type="checkbox"
              value="delete_stock_list"
              v-model="checkedPermissions"
            />
            <label class="form-check-label" for="delete_stock_list">
              Stock List
            </label>
          </div>
          <div class="form-group">
            <input
              class="form-check-input"
              type="checkbox"
              value="delete_users_list"
              v-model="checkedPermissions"
            />
            <label class="form-check-label" for="delete_user"> Users </label>
          </div>
          <div class="form-group">
            <input
              class="form-check-input"
              type="checkbox"
              value="delete_settings_list"
              v-model="checkedPermissions"
            />
            <label class="form-check-label" for="edit_settings">
              Settings
        ...
        <div class="col-md-2">
          ...
          <div class="form-group">
            <input
              ...
              v-model="checkedPermissions"
            />
            <label class="form-check-label" for="show_product"> Product </label>
          </div>
          <div class="form-group">
            <input
              class="form-check-input"
          ...
          <div class="form-group">
            <input
              class="form-check-input"
              type="checkbox"
              value="show_pick_list"
              v-model="checkedPermissions"
            />
            <label class="form-check-label" for="show_pick_list">
              Pick List
            </label>
          </div>
          <div class="form-group">
        ...
        <div class="col-md-2">
          ...
          <div class="form-group">
            <input
              ...
              v-model="checkedPermissions"
            />
            <label class="form-check-label" for="search_contact">
              Contact
            </label>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            <input
              class="form-check-input"
              type="checkbox"
              value="search_pick_list"
              v-model="checkedPermissions"
            />
            <label class="form-check-label" for="search_pick_list">
              Pick List
            </label>
          </div>
          <div class="form-group">
        ...
        <div class="row">
          <div class="col-md-8">
            <ul class="pagination">
              ...
              >
                <button
                  @click="fetchPermissions(pagination.first_link)"
                  class="page-link"
                >
                  First
                </button>
              ...
              >
                <button
                  @click="fetchPermissions(pagination.prev_link)"
                  class="page-link"
                >
                  Previous
                </button>
              ...
              >
                <button
                  @click="fetchPermissions(pagination.path_page + n)"
                  class="page-link"
                >
                  {{ n }}
                </button>
              ...
              >
                <button
                  @click="fetchPermissions(pagination.next_link)"
                  class="page-link"
                >
                  Next
                </button>
              ...
              >
                <button
                  @click="fetchPermissions(pagination.last_link)"
                  class="page-link"
                >
                  Last
                </button>
          ...
          <div class="col-md-4">
            ...
            Permissions: {{ pagination.total_pages }}
          </div>
        </div>
      </div>
...
export default {
  ...
  methods: {
    ...
    addPermission() {
      ...
      axios
        .post("/api/permission", this.permission)
        .then(function (response) {
        ...
        if (result.value) {
          axios
            ...
            .then(function (response) {
              ...
              let index_to_delete = currObj.permissions.findIndex(
    ...
    autoCompleteTable() {
      ...
      if (this.searchTableKey != "") {
        ...
        let currObj = this;
        axios
          .post("/api/permissions/search", { searchQuery: this.searchTableKey })
          .then(function (response) {
            currObj.isLoading = "";
