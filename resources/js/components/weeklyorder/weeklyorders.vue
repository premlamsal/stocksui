      ...
      <div class="card-body" v-if="weeklyorders.length > 0">
          ...
          >
            <thead>
              <tr>
                ...
                <th>Delivery Date</th>
                <!-- <th>Status</th> -->
                <th v-if="hasPermission('edit_weekly_order') || hasPermission('delete_weekly_order') || hasPermission('show_weekly_order') ">Edit</th>
              </tr>
            </thead>
            ...
            <tbody>
              ...
              >
                ...
                <td v-if="hasPermission('edit_weekly_order') || hasPermission('delete_weekly_order') || hasPermission('show_weekly_order')">
                  <button
        ...
        <div class="row">
          ...
          <div class="col-md-4">
            ...
            Weekly Orders: {{ pagination.total_pages }}
          </div>
        </div>
      </div>
  ...
  data() {
    return {
      ...
      preItemNameC: [
        ...
        "Liquid Hand Soap (5L)",
        "Conditioner (5L)",
        "Hair & Body Shampoo (5L)",
        "Tissues",
        "Toilet Roll (24pk)",
        "Blue Tork Roll",
        "Kitchen Roll",
        "Swing Bin Line (45L, 200 roll)",
        "Cabin Bin Liner (3l, 20pk)",
        "Black Bin Bags(200 box)",
      ],
      preItemNameM: [
        "Plastic Aprons",
        "Latex Gloves (Large)",
      ...
      preItemNameD: [
        "Comp / Galley / Crew Sheet",
        "Daily Bar Account Sheet",
        "Provisions Order Form",
        "Chef - 10 Day Clean Schedule",
        "Chef - Appliance TempSheet",
        "Chef Daily CleaningSheet",
      ],
