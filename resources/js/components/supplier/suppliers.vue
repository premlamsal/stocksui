      ...
      <div class="d-block">
        ...
        <div class="form-group">
          ...
          <input
            ...
            :class="['form-control']"
          />
          <span v-if="errors.contact_person" :class="['errorText']">{{
        ...
        <div class="table">
          ...
          >
            ...
            <tbody>
              <tr v-for="supplier in suppliers" v-bind:key="supplier.id">
                <!-- <td>{{supplier.id}}</td> -->
                <td @click="supplierProfile(supplier.id)" class="cursor">
                  {{ supplier.name }}
                </td>
        ...
        <div class="row">
          <div class="col-md-8">
            <ul class="pagination">
              ...
              >
                <button
                  @click="fetchSuppliers(pagination.first_link)"
                  class="page-link"
                >
                  First
                </button>
              ...
              >
                <button
                  @click="fetchSuppliers(pagination.prev_link)"
                  class="page-link"
                >
                  Previous
                </button>
              ...
              >
                <button
                  @click="fetchSuppliers(pagination.path_page + n)"
                  class="page-link"
                >
                  {{ n }}
                </button>
              ...
              >
                <button
                  @click="fetchSuppliers(pagination.next_link)"
                  class="page-link"
                >
                  Next
                </button>
              ...
              >
                <button
                  @click="fetchSuppliers(pagination.last_link)"
                  class="page-link"
                >
                  Last
                </button>
          ...
          <div class="col-md-4">
            ...
            Suppliers: {{ pagination.total_pages }}
          </div>
        </div>
      </div>
  ...
  methods: {
      ...
      axios
        ...
        .then((response) => {
          ...
          Vue.set(
            this.supplier,
            "contact_person",
            response.data.supplier.contact_person
          );
        ...
        if (result.value) {
          axios
            ...
            .then(function (response) {
              ...
              let index_to_delete = currObj.suppliers.findIndex(
    ...
    autoCompleteTable() {
      ...
      if (this.searchTableKey != "") {
        ...
        let currObj = this;
        axios
          .post("/api/suppliers/search", { searchQuery: this.searchTableKey })
          .then(function (response) {
            currObj.isLoading = "";
