...
class CreateWeeklyOrderDetailMSTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('weekly_order_detail_m_s', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('weekly_order_detail_m_s');
    }
}
